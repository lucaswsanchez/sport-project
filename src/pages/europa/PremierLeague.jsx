...
const PremierLeague = () => {
  const { europaTeams } = useContext(RegionContext);
  ...
  return (
    <div className="equipos-container">
      ...
      <div className="equipos">
        {europaTeams && europaTeams.premierLeague && europaTeams.premierLeague.equipos ? (
          europaTeams.premierLeague.equipos.map((equipo) => (
