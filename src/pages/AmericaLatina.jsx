          ...
          <div className="moment reverse">
            <div className="moment-description">
              <p>
                ...
                latinoamericano. Puedes destacar la pasión y la historia detrás
                de estos enfrentamientos, incluyendo la final histórica de la
                Copa Libertadores de 2018 que capturó la atención del mundo
                entero.
              </p>
            </div>
            <div className="moment-image">
