...
const TeamsTableLatinAmerica = ({ ligaProps }) => {
  ...
  return (
    <div className="table-container">
      ...
      <table>
        ...
        <tbody>
          {americaLatinaTeams &&
            americaLatinaTeams[ligaProps] &&
            americaLatinaTeams[ligaProps].equipos.map((equipo) => (
              <tr key={equipo.id}>
...
export default TeamsTableLatinAmerica;
